                    ...
                    <div>
                        <div className='' style={{color:'black',fontSize:'12px',marginBottom:'10px'}}>
                            ...
                            <div>
                                ...
                                <b style={{float:'left',marginLeft:'10px'}}>ไมล์</b><p style={{float:'left',marginLeft:'5px'}} >์ 335555</p>
                                <b style={{float:'left',marginLeft:'10px'}}>พนักงานขับรถ</b><p style={{float:'left',marginLeft:'5px'}}>นำยทักทำย ไหว้ตลอด</p>
                                <b style={{float:'left',marginLeft:'10px',marginRight:'5px',color:'green'}}><i class="bi bi-circle-fill"></i></b><p>อนุมัติแล้ว</p>
                            </div>
                        </div>
