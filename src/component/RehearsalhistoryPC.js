            ...
            <div className='indexpcfull'>
                <div className='containerpc' style={{marginLeft:"20px",marginRight:'20px'}}>
                    <div className='' style={{color:'black'}}>
                        ...
                        <b style={{float:'left',marginLeft:'10px',marginRight:'5px'}}>พนักงานขับรถ</b><p>นำยทักทำย ไหว้ตลอด</p>
                    </div>
                    <div style={{overflowX:'auto'}}>
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td>17/06/65</td>
                                <td>351,256</td>
                                <td>เปลี่ยนยำงใหม่หำงลำก ยำงเรเดียล 11R22.5 T559 FIRESTONE ล้อที่ 11,12,13,14,15,16,19,20</td>
                                <td>นำยทักทำย ไหว้ตลอด</td>
                                <td>ศูนย์สแกเนียน ้ำพอง</td>
                                <td>ดีเซล</td>
                            </tr>
...
export default RehearsalhistoryPC